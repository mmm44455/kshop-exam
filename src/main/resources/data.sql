...
VALUES          ('29V7-65366' , '2003-11-16', 'Nguyễn Ngọc Minh Trang', 'Bảo dưỡng lần 1', 'Honda'  ),
                ('29V7-52143' , '2021-03-05', 'Nguyễn Văn Khoa'       , 'Bảo dưỡng lần 4', 'Toyota' ),
                 ('29H1-65360' , '2003-11-16', 'Lê Bảo Bình', 'Bảo dưỡng lần 8', 'Toyota'  ),
                  ('29H2-52243' , '2021-03-05', 'Nguyễn Văn Thanh'       , 'Bảo dưỡng lần 5', 'Honda' );
...
VALUES                ('29V7-52143' , '2021-03-05', 'Cần gạt mưa', 999000 , 'Bị gãy'      , 'Thay mới'   ),
                      ('29H1-65360' , '2003-11-16', 'Lọc gió'    , 199000 , 'Bị bụi bẩn'  , 'Làm sạch'   ),
                      ('29H2-52243' , '2021-03-05', 'Lốp xe'     , 2000000, 'Bị thủng'    , 'Thay lốp'   ),
